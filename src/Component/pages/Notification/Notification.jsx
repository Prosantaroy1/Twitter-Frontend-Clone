        ...
        <div className="h-screen">
            <div className="container text-white font-fontpp mx-auto">
                ...
                <div className="flex px-5 py-3 items-center justify-between">
                    <h3 className="text-3xl font-medium">Notification</h3>
                ...
                <div className="pb-3 mt-3 border-b-2 border-slate-400">
                    <ul className="flex items-center lg:px-14 px-3 justify-between text-2xl font-semibold">
                        ...
                        <li className="hover:bg-slate-300 px-3 py-2 hover:text-black">Verify</li>
                        <li className="hover:bg-slate-300 px-3 py-2 hover:text-black">Mention</li>
                    </ul>
                </div>
                {/* text */}
                <div className="flex px-3 lg:px-12 items-center gap-3">
                    ...
                    <p className="text-2xl pt-4 ">
                        There was a login to your account @RoyProsant81869 from a new device on Aug 20, 2024. Review it now.
                    </p>
                </div>
            </div>
        </div>
